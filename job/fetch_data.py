...
def fetch_jobs():
    ...
    countryList = ['ca', 'gb', 'us', 'fr', 'br', 'de', 'es']
...
def genUrl(country, pageNum=1, results_per_page=200):
    app_id = '86f12d76'
    app_key = '513866e30fd4f984afc4b508c596b82b'
    path = 'https://api.adzuna.com/v1/api/jobs/'  # The URL from which you're fetching data

    return f'{path}{country}/search/{pageNum}?app_id={app_id}&app_key={app_key}&results_per_page={results_per_page}'
